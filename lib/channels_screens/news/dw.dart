...
class _MyVideoState extends State<DW> {
  ...
  void initState() {
    super.initState();
    firestore.collection("dw").get().then((QuerySnapshot querySnapshot) => {
        ...
        body: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: CircleAvatar(
                    radius: 40,
                    backgroundImage: AssetImage('assets/dw.jpg'),
                  ),
                ),
                Padding(
            ...
            Padding(
              ...
              child: Text(
                'DW is Germany‘s public international broadcaster brings the latest news in English from around the world.',
