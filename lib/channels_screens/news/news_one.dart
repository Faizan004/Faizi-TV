...
class _MyVideoState extends State<NewsOne> {
        ...
        body: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: CircleAvatar(
                    radius: 40,
                    backgroundImage: AssetImage('assets/newsone.jpg'),
                  ),
                ),
                Padding(
            ...
            Padding(
              ...
              child: Text(
                'News One airs 24/7 latest headline news bulletins and talk shows on current and political affairs of Pakistan',
