...
class _MyVideoState extends State<Dunya> {
  ...
  void initState() {
    super.initState();
    firestore.collection("dunya").get().then((QuerySnapshot querySnapshot) => {
        ...
        body: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: CircleAvatar(
                    radius: 40,
                    backgroundImage: AssetImage('assets/dunya.jpg'),
                  ),
                ),
                Padding(
            ...
            Padding(
              ...
              child: Text(
                'Enjoy the world of Dunya News: Pakistan’s most popular Urdu language news and current affairs television channel.',
