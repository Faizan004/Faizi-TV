...
class _MyVideoState extends State<Samaa> {
  ...
  void initState() {
    super.initState();
    firestore.collection("samaa").get().then((QuerySnapshot querySnapshot) => {
        ...
        body: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: CircleAvatar(
                    radius: 40,
                    backgroundImage: AssetImage('assets/samaa.jpg'),
                  ),
                ),
                Padding(
            ...
            Padding(
              ...
              child: Text(
                'Samaa TV is a Pakistani news and entertainment television network in urdu language.',
