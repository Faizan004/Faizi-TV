...
class _MyVideoState extends State<Neo> {
  ...
  void initState() {
    super.initState();
    firestore.collection("neo").get().then((QuerySnapshot querySnapshot) => {
        ...
        body: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'Neo News TV is the reflection of positive, proud and resilient Pakistan through world class journalism.',
