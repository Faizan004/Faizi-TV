...
class _MyVideoState extends State<CN> {
  ...
  void initState() {
    super.initState();
    firestore.collection("cn").get().then((QuerySnapshot querySnapshot) => {
        ...
        body: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: CircleAvatar(
                    radius: 40,
                    backgroundImage: AssetImage('assets/cn.jpg'),
                  ),
                ),
                Padding(
            ...
            Padding(
              ...
              child: Text(
                'Cartoon Network primarily broadcasts animated television series, mostly childrens programming, ranging from action to animated comedy.',
