...
class _MyVideoState extends State<MovieOne> {
        ...
        body: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: CircleAvatar(
                    radius: 40,
                    backgroundImage: AssetImage('assets/movieone.jpg'),
                  ),
                ),
                Padding(
            ...
            Padding(
              ...
              child: Text(
                'If you have got a passion for movies then MOVIE ONE is your one-stop, movie destination. From outrageous comedies and heart-stopping dramas to the fieriest action hits, Movie One has them all.',
