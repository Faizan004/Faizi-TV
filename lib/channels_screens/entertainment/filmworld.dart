...
class FilmWorld extends StatefulWidget {
  @override
  _MyVideoState createState() => _MyVideoState();
}

class _MyVideoState extends State<FilmWorld> {
        ...
        body: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: CircleAvatar(
                    radius: 40,
                    backgroundImage: AssetImage('assets/filmworld.jpg'),
                  ),
                ),
                Padding(
            ...
            Padding(
              ...
              child: Text(
                'Enjoy some of the best from Silver Screen right on the small screen.',
