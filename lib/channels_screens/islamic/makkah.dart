...
class _MyVideoState extends State<Makkah> {
  ...
  void initState() {
    super.initState();
    firestore.collection("makkah").get().then((QuerySnapshot querySnapshot) => {
        ...
        body: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: CircleAvatar(
                    radius: 40,
                    backgroundImage: AssetImage('assets/makkah.jpg'),
                  ),
                ),
                Padding(
            ...
            Padding(
              ...
              child: Text(
                'Saudi Quran Makkah TV is 24/7 Live Saudia Arabia Islamic TV Channel telecasted from Makkah.',
