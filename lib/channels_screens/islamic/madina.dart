...
class _MyVideoState extends State<Madina> {
  ...
  void initState() {
    super.initState();
    firestore.collection("madinah").get().then((QuerySnapshot querySnapshot) => {
        ...
        body: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: CircleAvatar(
                    radius: 40,
                    backgroundImage: AssetImage('assets/madinah.jpg'),
                  ),
                ),
                Padding(
            ...
            Padding(
              ...
              child: Text(
                'Saudi Sunnah Madinah TV is 24/7 Live Saudia Arabia Islamic TV Channel telecasted from Madinah.',
